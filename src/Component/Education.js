    ...
    return(
        <section id='education' style={{justifyContent:"space-between",border:"1px solid #ccc",borderRadius:'10px',padding:"20px",margin:"20px",backgroundColor:'#002e63',color:'white',marginRight:'5px',marginLeft:"5px"}}>
            ...
            <div style={{display:'flex',justifyContent:'space-around',gap:'20px',flexWrap:"wrap",textAlign:"center"}}>
                <div style={{ flex:'1',border:"1px solid #ccc",borderRadius:"10px",color:"black",textAlign:'center',marginBottom:'20px',backgroundColor:"#014f86",width:"250px"}}>
                ...
                <div style={{ flex:'1',color:'black', border:'1px solid #ccc',borderRadius:"10px",backgroundColor:"#014f86",marginBottom:"20px",textAlign:"center",width:"250px"}}>
