        ...
        <div style={{border:'1px solid #ccc',borderRadius:"10px",color:'white',backgroundColor:"#002e63",marginTop:"20px"}}>
            <section id="project" style={{justifyContent:"space-between",border:"1px solid #ccc",borderRadius:'10px',padding:"20px",margin:"20px",textAlign:'center'}}>
                ...
                <div style={{border:"1px solid #ccc",borderRadius:"10px",color:'black',backgroundColor:"white",textAlign:'center'}}>
                    ...
                    <p style={{textAlign:'left'}}>Developed a sales management system using Node.js, Express.js, and MySQL to streamline sales tracking andmanagement. The system includes RESTful APIs for handling sales records, customer data, and transactions, withall endpoints tested using Postman. MySQL was used to design an optimized database schema, ensuring efficient
